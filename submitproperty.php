                    ...
                    <div class="row p-5 bg-white">
                        <form method="post" enctype="multipart/form-data">
								<div class="description">
									<h5 class="text-secondary">Негізгі ақпарат</h5><hr>
									<?php echo $error; ?>
									<?php echo $msg; ?>
										...
										<div class="row">
											<div class="col-xl-12">
												<div class="form-group row">
													<label class="col-lg-2 col-form-label">Тақырып</label>
													<div class="col-lg-9">
												...
												<div class="form-group row mb-3">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="kzt">
															<option value="">Select KZT</option>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="1st Floor">1-інші Қабат</option>
															<option value="2nd Floor">2-інші Қабат</option>
															<option value="3rd Floor">3-інші Қабат</option>
															<option value="4th Floor">4-інші Қабат</option>
															<option value="5th Floor">5-інші Қабат</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
															<option value="">Қабатты таңданыз</option>
															<option value="1 Floor">1 Қабат</option>
															<option value="2 Floor">2 Қабат</option>
															<option value="3 Floor">3 Қабат</option>
															<option value="4 Floor">4 Қабат</option>
															<option value="5 Floor">5 Қабат</option>
															<option value="6 Floor">6 Қабат</option>
															<option value="7 Floor">7 Қабат</option>
															<option value="8 Floor">8 Қабат</option>
															<option value="9 Floor">9 Қабат</option>
															<option value="10 Floor">10 Қабат</option>
															<option value="11 Floor">11 Қабат</option>
															<option value="12 Floor">12 Қабат</option>
															<option value="13 Floor">13 Қабат</option>
															<option value="14 Floor">14 Қабат</option>
															<option value="15 Floor">15 Қабат</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Аумақ өлшемі</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="asize" required placeholder="Enter Area Size (in sqrt)">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Адресс</label>
													<div class="col-lg-9">
										...
										<div class="form-group row">
											...
											<div class="col-lg-9">
											<p class="alert alert-danger">* Маңызды! Төмендегі мазмұнды жоймаңыз. Тек өзгерту. <b>Ия</b> немесе <b>Жоқ</b> немесе Мәліметтер және қосымша мәліметтерді қоспаңыз</p>
											
											<textarea class="tinymce form-control" name="feature" rows="10" cols="30">
												<!---feature area start--->
												<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Меншік жасы : </span>10 жыл</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Жүзу бассейні : </span>Ия</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Паркинг : </span>Ия</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Спортзал : </span>Ия</li>
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Түрі : </span>Апартамент</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Қауіпсіздік : </span>Ия</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Асхана сыйымдылығы : </span>10 Адам</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Ғибадатхана : </span>Ия</li>
														
														</ul>
													</div>
													<div class="col-md-4">
														<ul>
														<li class="mb-3"><span class="text-secondary font-weight-bold">3-ші тарап : </span>Жоқ</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Лифт : </span>Ия</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Кабельдік теледидар : </span>Ия</li>
														<li class="mb-3"><span class="text-secondary font-weight-bold">Сумен жабдықтау : </span>Жер асты сулары/резервуар</li>
														</ul>
													</div>
												<!---feature area end---->
											</textarea>
										...
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control"  required name="status">
															<option value="">Статусты таңданыз</option>
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Жертөле қабатының жоспарының суреті</label>
													<div class="col-lg-9">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Еден жоспарының кескіні</label>
													<div class="col-lg-9">
														<input class="form-control" name="fimage" type="file">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Бірінші қабат жоспарының суреті</label>
													<div class="col-lg-9">
